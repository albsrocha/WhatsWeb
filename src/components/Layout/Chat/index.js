...
import SearhContent from "../SearchContent/index.js";
...
export default function ChatWindow({ user }) {
  ...
  const [textMessage, setTextMessage] = useState([
    ...
    { author: "", body: "Quem é você", time: "19:01" },
    { author: "1344", body: "Ola tudo bem?", time: "20:33" },
  ]);
  ...
  return (
    <div className="root">
      <div className="chatWindow" style={{ width: "100%" }}>
        <div className="chatWindow--header">
          ...
          <div className="chatWindow--headerbtn">
            <IconButton>
              <SearchIcon onClick={() => setNewWidth("40%")} />
            </IconButton>
        ...
        <div className="chatWindow--body">
          {textMessage.map((item, key) => (
            <Message user={user} key={key} data={item} />
          ))}
        </div>
